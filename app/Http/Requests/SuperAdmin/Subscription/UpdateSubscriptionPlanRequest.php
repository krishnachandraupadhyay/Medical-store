...
class UpdateSubscriptionPlanRequest extends FormRequest
{
    ...
    {
        $planId = $this->route('plan') instanceof SubscriptionPlan
            ? $this->route('plan')->id
            : (int) $this->route('plan');
        ...
        return [
            'name' => ['required', 'string', 'max:100', Rule::unique('subscription_plans', 'name')->ignore($planId)],
            'slug' => ['nullable', 'string', 'max:120', Rule::unique('subscription_plans', 'slug')->ignore($planId)],
    ...
    public function messages(): array
    {
        return [
            ...
            'slug.unique' => 'This plan slug is already in use by another plan.',
