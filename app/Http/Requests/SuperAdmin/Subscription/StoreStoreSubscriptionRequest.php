...
class StoreStoreSubscriptionRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'store_id' => [
                ...
                function (string $attribute, mixed $value, \Closure $fail) {
                    ...
                    if ($store && $store->status !== StoreStatus::ACTIVE) {
                        $fail('Subscriptions can only be assigned to an active medical store.');
                    }
                },
            ],
            'subscription_plan_id' => [
                ...
                function (string $attribute, mixed $value, \Closure $fail) {
                    ...
                    if ($plan && $plan->status !== PlanStatus::ACTIVE) {
                        $fail('Only active subscription plans can be assigned to stores.');
                    }
                },
            ],
            ...
            'supersede_active' => ['nullable', 'boolean'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'store_id.exists' => 'The selected medical store does not exist.',
            ...
            'status.required' => 'Please select a valid initial status.',
        ];
    }
}
