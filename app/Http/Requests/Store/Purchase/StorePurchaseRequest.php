...
class StorePurchaseRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'items.*.medicine_id.required' => 'Medicine is required for all items.',
            'items.*.batch_number.required' => 'Batch number is required for all items.',
            'items.*.expiry_date.required' => 'Expiry date is required for all items.',
            ...
            'items.*.mrp.required' => 'MRP is required.',
        ];
    }
}
