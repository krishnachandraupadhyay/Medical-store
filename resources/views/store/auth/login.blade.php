...
<head>
    ...
    <title>Store Owner Login | {{ config('app.name', 'MediStore') }}</title>
    ...
    <div class="w-full max-w-4xl bg-white rounded-3xl lg:rounded-[2rem] glass-card overflow-hidden grid grid-cols-1 md:grid-cols-2 my-auto">
        ...
        <div class="bg-gradient-to-br from-[#eef2fd] via-[#e7ecfc] to-[#dee5fa] p-8 sm:p-10 flex flex-col justify-between items-center text-center relative overflow-hidden border-b md:border-b-0 md:border-r border-slate-200/60">
            ...
            <div class="z-10">
                ...
                <p class="text-xs text-[#616e92] font-medium mt-1">Store Owner & Pharmacy Management Portal</p>
            </div>
            ...
            <div class="my-6 sm:my-8 relative w-full max-w-[300px] flex items-center justify-center z-10">
                <svg viewBox="0 0 320 280" class="w-full h-auto drop-shadow-md select-none" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Pharmacy Storefront in Background -->
                    <g transform="translate(125, 45)">
                        ...
                        <!-- Store Top Header Canopy -->
                        <polygon points="0,50 80,10 80,24 0,64" fill="#4b55c8" />
                        <circle cx="15" cy="54" r="2.5" fill="#f87171" />
                        <circle cx="23" cy="50" r="2.5" fill="#fbbf24" />
                        <circle cx="31" cy="46" r="2.5" fill="#34d399" />
                        
                        <!-- Pharmacy Cross on Storefront -->
                        <g transform="translate(35, 65)">
                            <circle cx="15" cy="15" r="12" fill="#e0e7ff" />
                            <path d="M15 7 V23 M7 15 H23" stroke="#4b55c8" stroke-width="3" stroke-linecap="round" />
                        </g>

                        <!-- Store Shelves & Storage -->
                        <line x1="95" y1="65" x2="145" y2="90" stroke="#c0cced" stroke-width="2" />
                        <line x1="95" y1="85" x2="145" y2="110" stroke="#c0cced" stroke-width="2" />
                        <rect x="105" y="55" width="10" height="8" fill="#4b55c8" rx="1" />
                        <rect x="120" y="62" width="10" height="8" fill="#60a5fa" rx="1" />
                    </g>

                    <!-- Large Isometric Medical Cross Badge Background -->
                    <g transform="translate(30, 60)">
                        <circle cx="45" cy="45" r="36" fill="#4b55c8" fill-opacity="0.9" />
            ...
            <!-- Bottom Branding -->
            <div class="z-10">
                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-100 text-[#4b55c8] text-xs font-bold">
        ...
        <div class="p-8 sm:p-12 lg:p-14 flex flex-col justify-between bg-white">
            ...
            <div>
                ...
                <div class="text-center mt-3 mb-7">
                    <h3 class="text-2xl sm:text-[26px] font-bold text-[#1e2746] tracking-tight">Store Owner Login</h3>
                    <p class="text-xs sm:text-sm text-[#64748b] mt-1">Sign in to manage your pharmacy and store inventory</p>
                </div>
                ...
                <!-- Login Form -->
                <form action="{{ route('store.login.submit') }}" method="POST" class="space-y-4" novalidate>
                    @csrf
                    ...
                    <div class="flex items-center justify-between pt-1 text-xs">
                        ...
                        <a href="javascript:void(0)" onclick="alert('Please contact your Platform Super Admin to request a password reset.')" class="text-[#64748b] hover:text-[#4b55c8] font-medium transition">
                            Forgot password?
                        </a>
                    </div>
                    ...
                    <div class="pt-3 flex justify-center">
                        <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-[#f1f5f9] text-[#475569] text-[11px] font-medium border border-[#e2e8f0]">
                            ...
                            <span>Encrypted Tenant Authentication</span>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <p class="text-center text-[11px] text-[#94a3b8] mt-8">
                &copy; {{ date('Y') }} Medistore SaaS Platform. All rights reserved.
            </p>
        </div>
