    ...
    <div class="bg-slate-900/90 border border-slate-800/80 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="p-6 border-b border-slate-800/80 bg-slate-950/40">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                    <h2 class="text-lg sm:text-xl font-bold text-white tracking-tight">Register New Medical Store</h2>
                    <p class="text-xs text-slate-400 mt-0.5">Fill in the required business details to provision a new medical store.</p>
                </div>
                <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-teal-500/10 border border-teal-500/30 text-teal-300 text-xs font-mono">
                    <span class="text-slate-400 text-[10px]">AUTO-CODE:</span>
                    <span class="font-bold">{{ $previewCode }}</span>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('super-admin.stores.store') }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div class="sm:col-span-2">
                        <label for="logo" class="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-1.5">
                            Store Branding / Logo <span class="text-slate-500 font-normal">(PNG, JPG, WEBP, max 2MB)</span>
                        </label>
                        <input
                            type="file"
                            name="logo"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-3.5 py-2 bg-slate-950/80 border @error('city') border-rose-500 @else border-slate-700/80 focus:border-teal-500 focus:ring-teal-500/20 @enderror rounded-xl text-white placeholder-slate-500 text-xs sm:text-sm focus:outline-none focus:ring-2 transition"
                        >
                        @error('city')
                            <p class="text-rose-400 text-[11px] mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-3.5 py-2 bg-slate-950/80 border @error('state') border-rose-500 @else border-slate-700/80 focus:border-teal-500 focus:ring-teal-500/20 @enderror rounded-xl text-white placeholder-slate-500 text-xs sm:text-sm focus:outline-none focus:ring-2 transition"
                        >
                        @error('state')
                            <p class="text-rose-400 text-[11px] mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label for="pincode" class="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-1.5">
                            Pincode / Postal Code <span class="text-rose-400">*</span>
                        </label>
                        <input
                            type="text"
                            name="pincode"
                            ...
                            class="w-full px-3.5 py-2 bg-slate-950/80 border @error('pincode') border-rose-500 @else border-slate-700/80 focus:border-teal-500 focus:ring-teal-500/20 @enderror rounded-xl text-white placeholder-slate-500 text-xs sm:text-sm focus:outline-none focus:ring-2 transition"
                        >
                        @error('pincode')
                            <p class="text-rose-400 text-[11px] mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-3.5 py-2 bg-slate-950/80 border @error('gstin') border-rose-500 @else border-slate-700/80 focus:border-teal-500 focus:ring-teal-500/20 @enderror rounded-xl text-white placeholder-slate-500 text-xs sm:text-sm focus:outline-none focus:ring-2 transition uppercase"
                        >
                        @error('gstin')
                            <p class="text-rose-400 text-[11px] mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-3.5 py-2 bg-slate-950/80 border @error('drug_license_no') border-rose-500 @else border-slate-700/80 focus:border-teal-500 focus:ring-teal-500/20 @enderror rounded-xl text-white placeholder-slate-500 text-xs sm:text-sm focus:outline-none focus:ring-2 transition"
                        >
            ...
            <div class="pt-6 border-t border-slate-800 flex items-center justify-end gap-3">
                <a href="{{ route('super-admin.stores.index') }}" class="px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-semibold transition">
                    Cancel
                </a>
                <button
                    type="submit"
