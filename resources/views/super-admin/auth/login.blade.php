...
<head>
    ...
    <title>Super Admin Portal | {{ config('app.name', 'MediStore') }}</title>
        ...
        <div class="p-8 sm:p-12 lg:p-14 flex flex-col justify-between bg-white">
            ...
            <div>
                ...
                <div class="text-center mt-3 mb-7">
                    <h3 class="text-2xl sm:text-[26px] font-bold text-[#1e2746] tracking-tight">Super Admin Portal</h3>
                    <p class="text-xs sm:text-sm text-[#64748b] mt-1">Manage your medical store platform</p>
                </div>
